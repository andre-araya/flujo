...
from utils import total_frame_number_writer, gamma_correction
from tracker import VehicleCounter, PathWay

# ============================================================================

# O/I Videos
INPUT_VIDEO_NAME = "../Lanamme/Videos/100GOPRO/output.ogv" #Sample_Videos/pretil.mp4" # Video file
...
def main():
    ...
    #bg_eq = gamma_correction(default_bg)
    ...
    while True:
        ...
        #Processing frame 
        processed = process_frame(frame_number, frame_counter, frame, bg_subtractor,                    car_counter, counter_line_Y, DIVIDER_COLOUR, 
                    BOUNDING_BOX_COLOUR, CENTROID_COLOUR, IMAGE_DIR)
